...
const ComicBubbleVideoPopup = ({ videoUrl, onClose, isDarkMode }) => {
  return (
    <motion.div
      ...
      className={`absolute z-50 -top-20 left-0  transform -translate-x-1/2 w-[22rem] h-56 bg-white rounded-2xl shadow-2xl border-4
        ...
        <motion.main className="text-center">
          ...
          >
            <FeatureCard
              ...
              title="Playground"
              description="Test Your  code quickly!"
              videoUrl="\ocp.mp4"
              isDarkMode={isDarkMode}
            />
            ...
            <FeatureCard
              icon={<UsersIcon className="text-green-400" />}
              title="Create Qustions For Comunity  "
              description="Connect, learn, and grow with a community of developers"
              videoUrl="ocp.mp4"
              isDarkMode={isDarkMode}
            />
